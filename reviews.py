...
data = pd.read_csv("data/winemag-data-130k-v2.csv/winemag-data-130k-v2.csv")
print(data.head())
print(data.columns)
...
print(result)
summary_filename = "data/reviews-per-country.csv"
result.to_csv(summary_filename, index=False)